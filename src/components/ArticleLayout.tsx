    ...
    <div>
      ...
      <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "2.5rem 1.5rem" }}>
        <div
          style={{
            display: "grid",
            gridTemplateColumns: toc.length > 0 ? "1fr 240px" : "1fr",
            gap: "2.5rem",
            alignItems: "start",
          }}
        >
                    ...
                    <li key={item.id}>
                      <a
                        ...
                        onMouseEnter={(e) => {
                          ...
                          el.style.backgroundColor = "rgba(6,182,212,0.06)";
                        }}
                        onMouseLeave={(e) => {
                          const el = e.currentTarget as HTMLElement;
                    ...
                    {article.badge && (
                      <span
                        style={{
                          ...
                          backgroundColor: `${article.badgeColor ?? "#06b6d4"}22`,
                          color: article.badgeColor ?? "#06b6d4",
                          border: `1px solid ${article.badgeColor ?? "#06b6d4"}44`,
                          borderRadius: "9999px",
